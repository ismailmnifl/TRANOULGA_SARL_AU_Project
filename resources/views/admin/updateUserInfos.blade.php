...
<head>
    <link rel="stylesheet" href="{{ url('css/updateUserInfo.css') }}">
    <style>
        #custom-file-upload {
                ...
                <div class="cardWrapper">
                    ...
                    <div class="container">
                        <div class="wrapper">
                            ...
                            @endif
                            <form action="{{ route('user.update.infos') }}" method="post" enctype="multipart/form-data">
                                @csrf   
                                ...
                                <div class="imageContainer">
                                    <div class="avatar">
                                        <img src="{{ url('uploads/images/'.$user->image) }}" alt="">
                                    </div>
                                </div>
                                ...
                                <div class="inputBox">
                                    <label>Role</label>
                                    <select name="role">
                                        <option style="color: red" value="{{ $user->role_id }}">valeur actuelle : {{ $user->role }}</option>
